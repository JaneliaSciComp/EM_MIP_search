...
1. Open a single CDM that containing the neuron; the CDM image needed to be aligned to JRC2018 unisex template space. (The newly aligned CDM also in https://www.janelia.org/open-science/color-depth-mip)
2. Write ROI on the image (use polygon tool and try to be as accurate as possible).
